...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    /* Foto do mentor (menor no mobile) */
    .photo-wrap{
      max-width: 360px;
      margin: 0 auto;
      padding: 14px;
        ...
        <div class="card pad">
          ...
          <div class="testimonials" aria-label="Depoimentos">
            ...
            <div class="t">
              ...
              <div class="who">Ricardo P.</div>
            </div>
            <div class="t">
              <p>“Percebi onde eu estava me anulando e consegui colocar limites sem brigar.”</p>
              <div class="who">Camila R.</div>
            </div>
            <div class="t">
              <p>“Foi como organizar a mente e o coração. Hoje eu escolho com mais maturidade.”</p>
              <div class="who">Fernando L.</div>
            </div>
          </div>
