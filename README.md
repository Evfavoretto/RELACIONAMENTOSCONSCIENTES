...
<head>
  ...
  <style>
    :root{
      /* Masculino + Feminino (fundo) */
      --masc: #0a1b3d;     /* azul profundo */
      --fem:  #4a0d3b;     /* vinho/ameixa */
      --gold: #d9b15f;
      --gold2:#f1d79a;
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      background:
        radial-gradient(900px 650px at 18% 20%, rgba(10,27,61,0.92), transparent 60%),
        radial-gradient(900px 650px at 82% 28%, rgba(74,13,59,0.90), transparent 62%),
        radial-gradient(900px 650px at 50% 0%, rgba(217,177,95,0.18), transparent 58%),
        linear-gradient(180deg, #060b18 0%, #050814 55%, #040612 100%);
      overflow-x:hidden;
    }
    ...
    /* Topbar (sem “título de GitHub”, só navegação interna) */
    .topbar{
    ...
    .btn:hover{ transform: translateY(-1px); border-color: rgba(217,177,95,0.68); }
    .btn.secondary{
    ...
    .glow{
      ...
      background: radial-gradient(circle at 30% 30%, rgba(241,215,154,0.26), transparent 62%);
      pointer-events:none;
      filter: blur(0.6px);
    }
    ...
    .info .big{ font-size: 15px; font-weight:850; color: var(--text); }
    ...
    .cta{
      ...
      background:
        radial-gradient(700px 340px at 50% 0%, rgba(217,177,95,0.26), transparent 65%),
    ...
    @media (max-width: 920px){
      ...
      .brandline{ display:none; } /* em telas pequenas, some para não poluir */
    }
  </style>
</head>
...
<body>
      ...
      <div class="grid">
        ...
        <aside class="card side" id="inscricao">
          ...
          <p style="margin:6px 0 0; color:var(--muted); line-height:1.75;">
            ...
            se perder de si nos relacionamentos e deseja se relacionar a partir de um lugar mais consciente,
            adulto e verdadeiro.
          </p>

          <!-- Botão principal (WhatsApp) -->
          <a class="btn" href="https://wa.me/5549998110445?text=Ol%C3%A1!%20Quero%20participar%20do%20Workshop%20Relacionamentos%20Conscientes%20(19%20e%2020%2F02%2F2026%20%C3%A0s%2020h).%20Pode%20me%20enviar%20os%20detalhes%3F" target="_blank" rel="noopener">
          ...
          <p style="margin:0; color:var(--muted2); font-size:13px; line-height:1.6;">
            *Se você tiver checkout, troque o link do botão para a página de pagamento e deixe um botão secundário para WhatsApp.*
          </p>
        </aside>
  ...
  <footer>
    <div class="wrap">
      <div class="footgrid">
        <div>
          <div style="font-weight:850; color:var(--text);">Workshop — Relacionamentos Conscientes</div>
