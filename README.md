      ...
      <div class="wrap">
        <div class="card pad">
          ...
          <details>
            ...
            <p class="ans">Faça o PIX para o CNPJ <b>48674960000163</b> (EA Favoretto LTDA) e envie o comprovante no WhatsApp.</p>
          </details>

          <details>
            <summary>Preciso estar em um relacionamento para participar?</summary>
            <p class="ans">Não. Esse workshop é sobre o seu lugar interno. Serve para quem está em relacionamento, para quem terminou, para quem está começando ou para quem quer se preparar melhor.</p>
          </details>
